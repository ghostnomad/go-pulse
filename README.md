...
- **Repo:** `https://github.com/yourusername/go-pulse-agent`
...
- **Repo:** `https://github.com/yourusername/go-pulse-server`
...
- [Agent Setup & Configuration](https://github.com/yourusername/go-pulse-agent)
- [Collector Server Setup](https://github.com/yourusername/go-pulse-server)